...
if(par != N and instance_exists(par)) {
    ...
    if(isStar) depth = lerp(layer_get_depth("MG"),layer_get_depth("MGFade")+10,pct); // Front
    else if(sprite_index == sprPix or isNova) depth = lerp(layer_get_depth("BG"),layer_get_depth("BGFade")+1,pct); // Middle
